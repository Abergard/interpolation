                                        ...
                                        std::wstring psFilename)
{
...
#ifdef DX_VERSION_11
    LPCSTR vertexLevel = "vs_5_0";
#else
    LPCSTR vertexLevel = "vs_4_0_level_9_3";
#endif
...
#ifdef DX_VERSION_11
    LPCSTR pixelLevel = "ps_5_0";
#else
    LPCSTR pixelLevel = "ps_4_0_level_9_3";
#endif
    ...
    // Release the vertex shader buffer and pixel shader buffer since they are
    // no longer needed.
